  ...
  return (
    <div className=' grid grid-cols-1 md:grid-cols-2 md:leading-10'>
        <div className=' flex flex-col md:justify-center items-start pt-20 md:pt-0 min-h-screen'>
            ...
            <span className=' font-normal text-md text-gray-400 '>Book the selected car effortless & pay for driving only.</span>
            <button className=' bg-slate-600  px-3 rounded-lg text-white mt-4 md:mt-0'>Explore</button>
        </div>
        <div>
            <div className=' rounded-lg md:right-44 absolute bottom-10 right-[1px]  w-[100%] h-[25%] md:w-[25%] md:h-[70%] bg-slate-500'></div>
